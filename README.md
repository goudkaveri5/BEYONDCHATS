...
# Laravel
/laravel-api/storage/*.key
/laravel-api/public/hot
/laravel-api/public/storage
/laravel-api/bootstrap/cache/*.php
...
4. Use Claude to rewrite the article
5. Save updated version via Laravel API
